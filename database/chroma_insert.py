# fonction pour insérer un chunk dans la collection ChromaDB
#version Kiril : database/chroma_insert.py
import pandas as pd
import numpy as np
...
# def add_chunks_to_collection(collection, chunks_df, embedding_fn):
#     """
#     Ajoute chaque chunk à la collection avec embeddings et métadonnées.
#     chunks_df doit contenir : ['article_id', 'chunk_id', 'text', 'label']
#     """
...
#                 documents=[row["text"]],
#                 metadatas=[metadata],
#                 embeddings=embedding_fn([row["text"]])
#             )
#         except Exception as e:
#             print(f"Erreur pour le chunk {chunk_id} : {e}")




# def add_chunks_to_collection(collection, dataframe, embedding_fn):
#     """
#     Ajoute chaque chunk à la collection avec embeddings et métadonnées
#     """
